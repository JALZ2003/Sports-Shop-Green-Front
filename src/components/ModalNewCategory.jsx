...
export default function ModalNewCategory({ show, setShow, setNewCategory, newCategory, setReload, reload, editP, seteditP }) {
    return (
        <>
            ...
            <div className='fixed z-40 inset-y-[5%] inset-x-[5%]  md:inset-x-[15%] lg:inset-x-[25%] w-full h-full'>
                <div className="relative rounded-2xl w-[90%] md:w-[70%] lg:w-[50%] h-[90%] bg-white border-2 border-blue overflow-auto  ">
                    <div onClick={() => {setShow(!show), setNewCategory(false)}} className="cursor-pointer absolute p-1.5 rounded-full right-[15px] top-[15px]">
