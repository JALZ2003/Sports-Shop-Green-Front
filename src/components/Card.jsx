        ...
        <div className={`bg-blue-200 p-1 md:p-2 lg:p-3 rounded-lg shadow-md border-l-4  border-gray-800/10`} style={{ borderColor: categoryColor }}>
            ...
            <div className="p-4 flex flex-col">
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <button className="bg-orange text-black font-bold rounded-full p-1 md:p-1 lg:p-2 hover:bg-orange-600 hover:-translate-y-1 transition-all duration-200 shadow-black shadow-md ">
                        <RiShoppingCart2Line />
                    </button>
                </div>
            </div>
