...
export default function CardCategories() {
    ...
    return (
        <div className="flex justify-around py-5 px-4 md:px-2 flex-wrap gap-8 bg-gray-200 -mt-6">
            {categories.map((each) => (
                <Anchor to={`/products/${each._id}`} key={uuidv4()} className="flex-col w-[300px] lg:w-[17%] h-[110px] md:[200px] lg:[300px] object-contain rounded-2xl overflow-hidden  shadow-lg">
