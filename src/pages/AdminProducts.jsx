    ...
    <div className='flex w-full h-screen'>
      ...
      <div className='w-full flex flex-col items-center pt-[180px] lg:pt-[30px] lg:pr-5 xl:pr-7 2xl:pr-10'>
        ...
        <div className='z-10 flex justify-center items-center max-[400px]:w-[360px] w-[400px] lg:w-[500px] bg-white pt-10'>
          ...
          <input onChange={(e) => dispatch(save_name({ name: e.target.value }))} defaultValue={productsStore.text}
            className='border-2 font-normal text-[20px] leading-[22.84px] p-[10px] text-center lg:text-start w-full rounded-r-lg hover:border-blue lg:outline-0'
            type="text"
      ...
      {show && <ModalNewProduct show={show} setShow={setShow} setAdd={setAdd} add={add} reload={reload} setReload={setReload}/>}
    </div>
  )
}
