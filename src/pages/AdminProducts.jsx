          ...
          <table className="w-[95%] ">
            <tbody className=" w-full rounded-lg">
              <tr className="w-full text-center bg-blue text-white">
                <th className="border-b-2 border-blue w-[10%]">
                  Name
                </th>
                <th className="border-b-2 border-blue w-[10%]">
                  Category
              ...
              <tr className="w-full text-center">
                <th className="border border-slate-400 w-[10%]">
                  hola
                </th>
                <th className="border border-slate-400 w-[10%]">
                  hola
                ...
                <th className="border border-slate-400 w-[10%]">
                  <div className='flex justify-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 mr-2 cursor-pointer transition hover:scale-105">
