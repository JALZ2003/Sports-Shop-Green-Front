                    ...
                    <div onClick={() => changeToggle(each)} className="flex justify-center items-center">
                      {!each.active? (
                        <label className="relative cursor-pointer h-[20px] w-[40px] rounded-full appearance-none bg-gray-400" htmlFor="toggle-switch">
                          ...
                          <span className="w-2/5 h-4/5 bg-white absolute rounded-full left-0.5 top-0.5 peer-checked:left-0.5 transition-all duration-500" />
                        </label>
                      ) : (
                        <label className="relative cursor-pointer h-[20px] w-[40px] rounded-full appearance-none bg-[#12b28c]" htmlFor="toggle-switch">
