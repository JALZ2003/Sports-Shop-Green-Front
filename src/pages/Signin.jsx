    ...
    <nav className='flex '>
      ...
      <div className=' bg-white w-[420px] h-[700px] z-10 mt-24 ml-5 xl:bg-opacity-70 xl:ml-[35%] xl:w-[30%]'>
        <div className='justify-items-centerer items-center relative lg:ml-2'>
          <h1 className='font-sans text-4xl text-black text-center mt-14 lg:mt-14 '>Connect!</h1>
          <h2 className=' text-black text-center mt-1 '>Enjoy all our products</h2>
          <div className='mt-12'>
            <h3 className=' text-black ml-8 font-medium' >Email</h3>
            <input className='w-[85%] ml-8 h-8  bg-slate-300' />
